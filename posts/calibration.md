...
- 보정된 확률이 입찰가로 바뀌는 경로 → [Bid Shading](post.html?id=bid-shading-censored)
- 보정이 시간에 따라 깨지는 문제 → [Online Learning 과 지연 피드백](post.html?id=online-learning-delayed-feedback)
