...
세 번째 이유는 비교의 편의성입니다. 어떤 지면은 하루 노출이 100번이고, 어떤 지면은 1억 번입니다. 규모가 이렇게 다른 지면을 "노출 1개당 가격"으로 비교하면 자릿수가 안 맞습니다. 1,000회라는 공통 단위로 맞추면 어디든 같은 잣대로 비교할 수 있습니다. eCPM(2.3절)이 하는 일이 바로 이것입니다. CPC도 CPA도, 결국 전부 CPM이라는 공통 단위로 환산해 비교합니다.
:::
