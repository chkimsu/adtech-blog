...
(function () {
    'use strict';
    // 그리기 부품은 card-kit.js 에 있다 (학습 데이터·서빙·실험 카드와 공용)
    const { esc, T, tw, box, labelUnder, tag, srv, table, db, file, tool, clock, user, list, dashChip, arrow, dots, burst, svg } = window.CardKit;
