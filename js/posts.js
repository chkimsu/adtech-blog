...
const posts = [
  ...
  },
  {
    ...
    world: 'walled-garden',
    worldNote: 'DSP 모양이어도 외부 거래소 없이 자사 지면 내부경매 — 거래소·SSP·매체가 한 회사.',
  ...
  },
  {
    ...
    world: 'walled-garden',
    worldNote: '3rd-party 쿠키가 아니라 자사 로그인 통합데이터가 피처·라벨의 전제(open-RTB와 반대).',
  ...
  },
  {
    ...
    world: 'walled-garden',
    worldNote: '자동입찰=플랫폼이 패를 다 보고 대신 깎기. open-RTB의 censored bid shading과 정반대.',
  ...
  },
  {
    id: 'ltv-ad-ranking',
    world: 'walled-garden',
    worldNote: '지면·유저를 소유한 플랫폼만 eCPM에서 user-cost를 빼 장기가치로 랭킹 가능. 외부 DSP는 노출 여부를 통제 못 함.',
