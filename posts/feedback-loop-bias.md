...
**첫날 표본으로 잰 클릭률은 가장 좋은 광고와 중간쯤 되는 광고를 못 나눈다. 그런데 그 값이 둘째 날 노출을 결정한다.**

첫날 여덟은 아직 어느 쪽이 좋은지 모르니 노출을 500건씩 똑같이 받는다. 첫날이 끝나면 광고마다 클릭 수가 하나씩 붙고, 그 숫자 하나가 둘째 날의 예산 배분을 결정한다.

문제는 첫날 표본이 작다는 것이다. 진짜 클릭률이 2.60% 인 A 라 해도 500건 중 클릭은 8건에서 18건 사이 어디로든 나온다. 그 폭 안에서 남은 39일의 예산이 정해진다.
...
클릭 3.6건을 클릭률로 옮기면 0.0072, 즉 0.72%p 다. 가장 좋은 광고는 2.60% 이고 넷째로 좋은 광고는 2.20% 인데, 이 흔들림은 그 둘 사이 간격을 덮고도 남는다.
...
40세대가 끝나면 예산이 이렇게 나뉜다. B 와 C 가 각각 234,500건, E 가 208,500건, F 가 102,500건을 가져갔다.
