// ===================================================================
// 파이프라인 코스 2페이지 — 3~4절 위젯
//   js/pipeline-course-sections.js
//
// 이 파일이 담는 절 — 3절(Kafka 로 모으는 이유), 4절(topic 에 놓인 뒤
// 누가 언제 읽어 가나). 5~7절은 js/pipeline-course-sections2.js 에 있다.
//
...
// 문다). 이 파일은 이제 3~4절만 갖는다. Task 12 는 7절을 sections2.js 에
// 이어 붙였다 — sections3.js 를 새로 만들지 않았다.
// ===================================================================
(function () {
  'use strict';
